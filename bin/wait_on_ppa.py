...
def get_lp():
    return Launchpad.login_anonymously('unity-merger', 'production')
...
if __name__ == '__main__':
    ...
    parser.add_option("-v", "--version", dest="deb_version",
                      help="version of source package")
    parser.add_option("-o", "--owner", dest="owner",
                      default="unity-team",
                      help="owner of ppa")
    parser.add_option("-p", "--ppa-name", dest="ppa",
                      default="staging",
                      help="name of ppa")
    (options, args) = parser.parse_args()

    exit(not watch(options.owner, options.ppa, options.source_package, options.deb_version))
